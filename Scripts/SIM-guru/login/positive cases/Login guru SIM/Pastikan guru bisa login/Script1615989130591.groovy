...
'User click pop-up kehadiran = button nanti'
WebUI.callTestCase(findTestCase('SIM-guru/login/positive cases/Login guru SIM/Pop-up kehadiran nanti'), [:], FailureHandling.STOP_ON_FAILURE)
