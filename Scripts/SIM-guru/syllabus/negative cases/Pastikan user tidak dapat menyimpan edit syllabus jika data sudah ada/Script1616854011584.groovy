...
WebUI.click(findTestObject('admin/Page_Edit Syllabus - Pijar Sekolah/div_V-F'))
...
WebUI.verifyElementText(findTestObject('admin/Page_Tambah Syllabus - Pijar Sekolah/h3_Gagal'), 'Gagal!')

WebUI.click(findTestObject('admin/Page_Tambah Syllabus - Pijar Sekolah/button_Ok'))
