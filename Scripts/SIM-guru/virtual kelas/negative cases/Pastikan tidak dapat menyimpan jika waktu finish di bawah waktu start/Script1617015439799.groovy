...
WebUI.setText(findTestObject('admin/Page_Add Kelas Virtual - PIJAR/input_-_timeFinish'), '09:00')
...
WebUI.verifyElementText(findTestObject('admin/Page_Add Kelas Virtual - PIJAR/span_Waktu selesai tidak boleh sama  lebih kecil dari waktu mulai'), 
    'Waktu selesai tidak boleh sama / lebih kecil dari waktu mulai')
