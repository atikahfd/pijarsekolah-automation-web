...
WebUI.verifyElementText(findTestObject('admin/Page_Add Kelas Virtual - PIJAR/span_Guru Susi QA memiliki jadwal kelas virtual pada waktu tersebut - Copy'), 
    'Guru Susi QA memiliki jadwal kelas virtual pada waktu tersebut')
