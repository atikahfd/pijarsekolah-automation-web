...
WebUI.verifyElementText(findTestObject('admin/Page_Edit Kelas Virtual - PIJAR/span_kelas V-B sudah memiliki jadwal kelas virtual pada waktu tersebut'), 
    'kelas V-B sudah memiliki jadwal kelas virtual pada waktu tersebut')
