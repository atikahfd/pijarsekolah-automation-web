...
WebUI.click(findTestObject('admin/Page_Pengumuman - PIJAR/button_2'))

'User click button previous'
WebUI.click(findTestObject('admin/Page_Syllabus - Pijar Sekolah/button_Ganjil_previous-btn'))

'User click button Last Page'
WebUI.click(findTestObject('admin/Page_Pengumuman - PIJAR/button_tes_last-btn'))
