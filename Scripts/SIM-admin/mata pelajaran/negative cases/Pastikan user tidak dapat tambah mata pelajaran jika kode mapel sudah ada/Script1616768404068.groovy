...
WebUI.verifyElementText(findTestObject('admin/Page_Tambah Daftar Pelajaran - PIJAR/span_Kode Mapel Sudah Pernah Digunakan Silahkan Masukkan Kode Lain'), 
    'Kode Mapel Sudah Pernah Digunakan, Silahkan Masukkan Kode Lain')
