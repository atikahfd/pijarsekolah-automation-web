...
'Kode Mata Pelajaran : IPA2'
WebUI.verifyElementText(findTestObject('admin/Page_Detail Daftar Pelajaran - PIJAR/td_IPA2'), 'IPA2')

'Mata Pelajaran : Ilmu Pengetahuan Alam'
WebUI.verifyElementText(findTestObject('admin/Page_Detail Daftar Pelajaran - PIJAR/td_mapel_Ilmu Pengetahuan Alam'), 'Ilmu Pengetahuan Alam')

'Deskripsi : Ilmu Pengetahuan Alam'
WebUI.verifyElementText(findTestObject('admin/Page_Detail Daftar Pelajaran - PIJAR/td_deskripsi_Ilmu Pengetahuan Alam'), 
