...
WebUI.verifyElementText(findTestObject('admin/Page_Profil Siswa - PIJAR/h3_Success'), 'Success')

WebUI.click(findTestObject('admin/Page_Profil Siswa - PIJAR/button_exit'))
