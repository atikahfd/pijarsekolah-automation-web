...
WebUI.click(findTestObject('admin/Page_Daftar Guru - PIJAR/button_previous-btn'))
...
WebUI.click(findTestObject('admin/Page_Daftar Guru - PIJAR/button_first-btn'))

'User click button next'
WebUI.click(findTestObject('admin/Page_Daftar Guru - PIJAR/button_next-btn'))
